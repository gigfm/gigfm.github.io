...
(function () {
  ...
  window.R = window.rdio = window.__rdio = {
    _config: {
      client_id: "c5zugitjrfft7f3mvzbjzajaaa",
      helper: "helper.html",
      iframe: "https://www.rdio.com/api/iframe/?client_id=c5zugitjrfft7f3mvzbjzajaaa",
      oauth2: "https://www.rdio.com/oauth2/authorize/",
      oauth2Auto: "https://www.rdio.com/oauth2/authorize/auto/",
      logout: "https://www.rdio.com/oauth2/logout/?client_id=c5zugitjrfft7f3mvzbjzajaaa",
  ...
  injectScript("https://www.rdio.com/media/api/api-impl.847249fd8ce685946c6d990ec8404cff.js");
})();
...
(function (R) {
  ...
  function dialog(message) {
    ...
    el.innerHTML = '<div>' + message + '</div><br><button>OK</button>';
...
(function (R, rdioUtils) {
  ...
  rdioUtils.AlbumWidget = function (album) {
    ...
    if (this._broken) {
      this._element.innerHTML = '' + '<div class="rdio-utils-album-cover">' + '<div class="rdio-utils-album-icon"></div>' + '</div>' + '<div class="rdio-utils-album-title rdio-utils-truncated">Unknown Album</div>' + '<div class="rdio-utils-album-author rdio-utils-truncated">&nbsp;</div>' + '<div class="rdio-utils-album-size rdio-utils-truncated">&nbsp;</div>';

      return;
    }

    var html = '' + '<div class="rdio-utils-album-cover">' + '<a href="http://www.rdio.com' + rdioUtils._escape(album.url) + '">' + '<div class="rdio-utils-album-icon" style="background-image: url(' + rdioUtils._escape(album.icon) + ')"></div>' + '<div class="rdio-utils-album-hover-overlay">' + '<div class="rdio-utils-album-play-btn"></div>'
    // + '<div class="rdio-utils-album-action-btn"></div>'
     + '</div>' + '</a>' + '</div>' + '<div class="rdio-utils-album-title rdio-utils-truncated"><a href="http://www.rdio.com' + rdioUtils._escape(album.url) + '">' + rdioUtils._escape(album.name) + '</a></div>' + '<div class="rdio-utils-album-author rdio-utils-truncated"><a href="http://www.rdio.com' + rdioUtils._escape(album.artistUrl) + '">' + rdioUtils._escape(album.artist) + '</a></div>';

    if (album.length) {
      html += '<div class="rdio-utils-album-size rdio-utils-truncated">' + rdioUtils._escape(album.length) + ' songs</div>';
    }
...
(function (R, rdioUtils) {
  ...
  rdioUtils.CollectionTracker = function (config) {
    ...
    this._bigExtras = '-*,releaseDate,duration,isClean,canStream,icon,' + 'canSample,name,isExplicit,artist,url,length,trackKeys,artistUrl';
...
},{"../../bower_components/jquery/dist/jquery":1,"../../bower_components/rdio-api/index.js":2,"../../lib/modernizr.touch.js":3,"../../lib/rdio-utils/rdio-utils.js":4,"../../lib/underscore.js":5}]},{},[6]);
